...
public class TrecPipelineQCandQFRunner {
	...
	private static final String TRAIN_QUESTION_CLASS = "trainQuestionCategories";
	private static final String TEST_QUESTION_CLASS = "testQuestionCategories";
	private static final String TRAIN_QUESTION_FOCUS = "trainQuestionFocus";
	private static final String TEST_QUESTION_FOCUS = "testQuestionFocus";
	...
	public static void main(String[] args) throws UIMAException, IOException {
		...
		//String [] argz = new String[]{"-argumentsFilePath", "arguments/trec-en-pipeline-arguments-qc-foc-toy.txt"};
		//args = argz;
		...
		options.addOption(TRAIN_QUESTION_CLASS, true,
				"The path of the file containing the classes of the train questions");
		options.addOption(TEST_QUESTION_CLASS, true,
				"The path of the file containing the classes of the test questions");
		options.addOption(TRAIN_QUESTION_FOCUS, true,
				"The path of the file containing the focus of the train questions");
		options.addOption(TEST_QUESTION_FOCUS, true,
				"The path of the file containing the focus of the test questions");
		...
		try {
			...
			String trainQuestionCategories = getFileOption(cmd,
					TRAIN_QUESTION_CLASS,
					"Please specify the path of the training questions classes file.");
			String testQuestionCategories = getFileOption(cmd,
					TEST_QUESTION_CLASS,
					"Please specify the path of the test questions classes file.");
			String trainQuestionFocus = getFileOption(cmd,
					TRAIN_QUESTION_FOCUS,
					"Please specify the path of the training questions focus file.");
			String testQuestionFocus = getFileOption(cmd,
					TEST_QUESTION_FOCUS,
					"Please specify the path of the test questions focus file.");
			 ...
			 * for train CASes
			 */
			Analyzer ae = pipeline.instantiateQCAndQFFromFileAnalyzer(trainPersistence, trainQuestionCategories, trainQuestionFocus);
			 ...
			 */
			ae = pipeline.instantiateQCAndQFFromFileAnalyzer(testPersistence, testQuestionCategories, testQuestionFocus);
